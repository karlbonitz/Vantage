...
function Vantage:ShowHelp()
    ...
    print("  /vantage priority - shout only for the top-priority cast when several are up")
    ...
    print("  /vantage announce - call out your interrupts to party chat (off)")
    print("  /vantage kicks    - who in your group has an interrupt ready now")
    ...
    print("  /vantage share    - export your learned kicks as an Intel Pack string")
    print("  /vantage import   - merge a shared Intel Pack string into yours")
